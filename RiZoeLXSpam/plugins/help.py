...
Riz_Help = "🔥 𝗥𝗢𝗡𝗜𝗡 𝗫 𝗦𝗣𝗔𝗠 🔥\n\n"
 
Riz_Help += f"__ᴄᴍᴅs ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ 𝗿𝗼𝗻𝗶𝗻 x sᴘᴀᴍ__\n\n"
...
Riz_Help += f"© @DushmanXRonin | @DushmanXRonin\n"
...
async def help(event):
    if event.sender_id in SUDO_USERS:
     await Riz.send_file(event.chat_id,
                                  ...
                                  buttons=[
        [
        Button.url("ᴀʟʟ ᴄᴍᴅs", "https://telegra.ph/file/71368798b617ea51ed005.jpg7%A0-11-28-2")
        ],
        [
